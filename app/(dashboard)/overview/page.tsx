      ...
      <div className="flex flex-col xl:flex-row gap-4">
        ...
        <div className="flex-1 flex flex-col gap-4">
          <div className="flex flex-col md:flex-row gap-4 h-full">
            {/* Pipeline (standalone) */}
            <div className="panel gold-gradient-bg p-4 flex flex-col items-center justify-center min-w-[140px] shadow-sm ring-1 ring-border-color hover:-translate-y-0.5 hover:shadow-md transition duration-200 ease-out border-none" style={{ animationDuration: "240s" }}>
